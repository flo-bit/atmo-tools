import type { Embed, EmbedRecordData, PostData } from '@foxui/social';
...
export function blueskyPostToPostData(
	...
	const replyTo = reply?.parent?.author
		? {
...
export function blueskyPostToHTML(
	...
	const hrefs = typeof hrefsOrBaseUrl === 'string' ? defaultHrefs(hrefsOrBaseUrl) : hrefsOrBaseUrl;
